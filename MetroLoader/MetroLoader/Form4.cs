...
namespace MetroLoader
{
    public partial class Form4 : MetroForm
    {
        ...
        {
            webBrowser1.Navigate(Settings.host + "group.php?username=" + Properties.Settings.Default.Username);
        ...
        private void metroButton1_Click(object sender, EventArgs e)
        {
            ...
            if (metroRadioButton1.Checked == true) // Premium
            {
                ...
                wb.Headers.Add("User-Agent", Settings.user_agent);
                Settings.file = Convert.FromBase64String(wb.UploadString(Settings.host + "dlls/download.php", "cheat=premium"));
            }
            ...
            if (metroRadioButton2.Checked == true) // Developer
            {
                ...
                wb.Headers[HttpRequestHeader.ContentType] = "application/x-www-form-urlencoded";
                wb.Headers.Add("User-Agent", Settings.user_agent);
                Settings.file = Convert.FromBase64String(wb.UploadString(Settings.host + "dlls/download.php", "cheat=admin"));
            }
